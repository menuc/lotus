...
var storageAttachCmd = &cli.Command{
	...
	Description: `Storage can be attach to the miner using this command. The storage volume
list is stored local to the miner in $LOTUS_MINER_PATH/storage.json. We do not
recommend modifying this value without further understanding of the storage
system.
